...
export const actuatorsBlocks: ContentBlock[] = [
  {
    type: "callout",
    tone: "info",
    text: "传动部件物理极限：旋转关节需承受大扭矩冲击与频繁倒转，直线关节需解决反向驱动与高疲劳寿命问题；灵巧手微型电机需满足高响应速度与高功率密度（公司口径披露）。",
    sourceIds: ["S-HUMANOID-GREENHARMONIC-FILING", "S-HUMANOID-MOONS-FILING"],
  },
  {
    type: "paragraph",
  ...
  },
  {
    ...
    rows: [
      ["谐波减速器", "体积小、重量轻、传动比大", "柔轮易疲劳失效、刚度较低", "旋转关节（肩/肘/手腕）", "高交叉滚子轴承与材料抗疲劳寿命"],
      ["行星滚柱丝杠", "承载能力大、寿命长、耐冲击", "加工极为复杂、成本高昂", "直线执行器（腿部/膝盖伸缩）", "硬旋风铣削设备与精密滚柱加工"],
      ["空心杯电机", "无齿槽效应、响应速度快", "功率密度受限、散热较难", "灵巧手指关节驱动", "微型绕线机与高磁能积永磁体装配"],
    ],
