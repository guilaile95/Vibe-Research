...
export const airworthinessBlocks: ContentBlock[] = [
  ...
  },
  {
    ...
    items: [
      ...
      "运营许可/运行批准：运营商需取得 CCAR-135R3 部与 CCAR-91-R4 部运行合格证（AOC）后才能投入商业载客或作业运营。",
    ],
  ...
  },
  {
    ...
    sourceIds: ["S-LOWALT-ISO26262-STD", "S-LOWALT-DO-178C", "S-LOWALT-DO-254", "S-LOWALT-AVICHIGHTECH-FILING"],
  },
  {
    type: "table",
    ...
    rows: [
      ...
      ["适航/安全标准", "极高（DO-178C/DO-254）", "高（ISO 26262）", "基于航空级可能部分采用汽车级（分析推断）"],
      ["培训和维护网络", "低频专业维修", "密集型网点", "需要新型分布式维护体系（分析推断）"],
    ],
    sourceIds: ["S-LOWALT-ISO26262-STD", "S-LOWALT-DO-178C", "S-LOWALT-DO-254", "S-LOWALT-EASA-SC-VTOL"],
  },
  {
    type: "callout",
    tone: "warning",
  ...
  {
    type: "paragraph",
    text: "商业运营条件：除适航取证外，eVTOL 商业运营还需满足（1）运营基地获得起降场使用许可；（2）运营商取得 CCAR-135R3 部运行合格证；（3）空管部门完成低空航线划设与动态空域分配；（4）保险产品覆盖；（5）公众接受度。上述条件中任一滞后都会拖累商业运营的启动节奏。（分析推断）",
    sourceIds: [
  ...
  },
  {
    ...
    items: [
      ...
      "运营许可滞后：即使取得 TC/PC，运营商取得运行合格证（CCAR-135R3）的进度也可能慢于预期。",
