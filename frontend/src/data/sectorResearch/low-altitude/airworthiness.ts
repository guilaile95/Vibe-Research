...
export const airworthinessBlocks: ContentBlock[] = [
  ...
  },
  {
    type: "bullets",
    items: [
      "TC（型号合格证）：确认型号设计符合民航规章适航标准（CCAR-21-R5）；是适航认证中最耗时、成本最高的环节，通常耗时 3–7 年（分析推断 / 行业历史经验区间）。",
      "PC（生产许可证）：确认制造企业具备批量生产符合批准型号设计产品的能力（CCAR-21-R5）。",
      "AC（单机适航证）：确认单架航空器符合经批准的型号设计，可投入运营（CCAR-21-R5）。",
      "运营许可/运行批准：运营商需取得 CCAR-135 部与 CCAR-91 部运行合格证（AOC）后才能投入商业载客或作业运营。",
    ],
    sourceIds: ["S-LOWALT-CAAC-CCAR21", "S-LOWALT-CAAC-CCAR91", "S-LOWALT-CAAC-CCAR135"],
  },
  {
    type: "paragraph",
    text: "全球 eVTOL 适航进展概览：EASA 发布了 SC-VTOL-01 专用条件基准，FAA 采用 Part 21.17(b) 专用类适航标准，CAAC 也在推进 eVTOL 型号合格审定。亿航智能 EH216-S 于 2023 年 10 月取得 CAAC 颁发的型号合格证（TC），为全球首张无人驾驶载人 eVTOL 型号合格证；国内其他主要 eVTOL 项目（如沃飞长空、峰飞航空等）尚在适航取证过程中，具体阶段节点需以后续官方公告为准。（分析推断）",
    sourceIds: ["S-LOWALT-CAAC-CCAR21", "S-LOWALT-EH216-TC", "S-LOWALT-EASA-SC-VTOL", "S-LOWALT-FAA-21-17B"],
  },
  {
    type: "callout",
    tone: "info",
  ...
  },
  {
    ...
    sourceIds: ["S-LOWALT-ISO26262-STD", "S-LOWALT-DO-178C-254", "S-LOWALT-AVICHIGHTECH-FILING"],
  },
  {
    type: "table",
    caption: "eVTOL 量产挑战对比：航空级 vs 汽车级供应链标准（内部分析）",
    headers: ["维度", "航空级供应链", "汽车级供应链", "eVTOL 实际需求"],
    rows: [
      ["质量认证周期", "长（2–5 年，行业经验值）", "短（6–18 个月，行业经验值）", "介于中间（分析推断）"],
      ["批量规模", "小批量（数十到几百/年）", "大批量（百万/年）", "千–万量级/年（行业预测）"],
      ["单件成本容忍度", "高", "极低", "中等（需要显著降本）"],
      ["适航/安全标准", "极高（DO-178C/DO-254）", "高（ISO 26262）", "基于航空级可能部分采用汽车级"],
      ["培训和维护网络", "低频专业维修", "密集型网点", "需要新型分布式维护体系"],
    ],
    sourceIds: ["S-LOWALT-ISO26262-STD", "S-LOWALT-DO-178C-254", "S-LOWALT-EASA-SC-VTOL"],
  },
  {
    type: "callout",
    tone: "warning",
  ...
  {
    type: "paragraph",
    text: "商业运营条件：除适航取证外，eVTOL 商业运营还需满足（1）运营基地获得起降场使用许可；（2）运营商取得 CCAR-135 部运行合格证；（3）空管部门完成低空航线划设与动态空域分配；（4）保险产品覆盖；（5）公众接受度。上述条件中任一滞后都会拖累商业运营的启动节奏。（分析推断）",
    sourceIds: [
  ...
  },
  {
    ...
    items: [
      ...
      "运营许可滞后：即使取得 TC/PC，运营商取得运行合格证（CCAR-135）的进度也可能慢于预期。",
      "国际认证互认有限：CAAC vs EASA vs FAA 之间的互认程度有限，国产 eVTOL 出海面临二次认证成本。",
    ],
    sourceIds: ["S-LOWALT-CAAC-CCAR21", "S-LOWALT-CAAC-CCAR135", "S-LOWALT-EASA-SC-VTOL", "S-LOWALT-FAA-21-17B"],
  },
];
