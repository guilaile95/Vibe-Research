  ...
  const leads = [
    {
      ...
      source: `行业排名 · 交易日 ${industrySource?.trade_date || "未提供"} · 行情时间 ${industrySource?.data_time || "未提供"}`,
    ...
    },
    {
      ...
      source: `全 A 快照 · 交易日 ${breadthSource?.trade_date || "未提供"} · 行情时间 ${breadthSource?.data_time || "未提供"}`,
